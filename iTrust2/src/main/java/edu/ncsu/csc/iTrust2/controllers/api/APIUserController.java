...
public class APIUserController extends APIController {
    ...
    /** Constant for billing specialist role */
    private static final String       ROLE_BILL_SPEC  = "ROLE_BILL_SPEC";

    /** All roles */
    private static final List<String> ALL_ROLES       = List.of( ROLE_ADMIN, ROLE_PATIENT, ROLE_HCP, ROLE_ER,
            ROLE_LABTECH, ROLE_VIROLOGIST, ROLE_OD, ROLE_OPH, ROLE_VACCINATOR, ROLE_BILL_SPEC );
    ...
    public ResponseEntity generateUsers () {
        ...
        final User bill_spec = new Personnel( new UserForm( "billing_specialist", "123456", Role.ROLE_BILL_SPEC, 1 ) );

        userService.save( admin );

        userService.save( doc );

        userService.save( bill_spec );
