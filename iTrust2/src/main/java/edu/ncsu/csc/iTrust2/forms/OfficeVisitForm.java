...
public class OfficeVisitForm implements Serializable {
    ...
    /**
     * CPT Codes associated with the Office Visit
     */
    ...
    public OfficeVisitForm ( final OfficeVisit ov ) {
        ...
        setCptCodes( new ArrayList<CPTCodeForm>() );
    }
    ...
    /**
     * Sets the list of CPT Codes within the Office Visit
     *
     * @param newCPTCodes
     *            The new list of CPT Codes
     */
    public void setCptCodes ( final List<CPTCodeForm> newCPTCodes ) {
        this.cptCodes = newCPTCodes;
    }
