...
public enum TransactionType {
     ...
     * Creating a CPT Code
     */
    CPT_CODE_CREATE ( 1700, "Created CPT Code", false ),

    /**
     * Editing CPT Code
     */
    CPT_CODE_EDIT ( 1701, "Edited CPT Code", false ),

    /**
     * Deleting CPT Code
     */
    CPT_CODE_DELETE ( 1702, "Deleted CPT Code", false ),

    /**
     * Viewing CPT Code
     */
    CPT_CODE_VIEW ( 1703, "Viewed CPT Code", false ),

    /**
     * Viewing CPT Codes within Office Visit
     */
    OFFICE_VISIT_CPT_CODE_VIEW ( 1704, "View CPT Codes within Office Visit", false ),

    /**
     * Adding CPT Code to Office Visit
     */
    OFFICE_VISIT_CPT_CODE_ADD ( 1705, "Added CPT Code to Office Visit", false ),

    /**
     * Deleting CPT Code to Office Visit
     */
    OFFICE_VISIT_CPT_CODE_DELETE ( 1706, "Removed CPT Code from Office Visit", false ),

    /**
     * Patient viewed their own bills list.
     */
    PATIENT_VIEW_BILLS_LIST ( 2301, "Patient viewed bills list", true ),

    /**
     * Patient viewed one of their own bills.
     */
    PATIENT_VIEW_BILL ( 2302, "Patient viewed specific bill", true ),

    /**
     * Billing specialist viewed a list of bills for a patient.
     */
    BILL_SPEC_VIEW_BILLS_LIST ( 2303, "Billing Specialist viewed bills list", true ),

    /**
     * Billing specialist viewed specific bill for patient.
     */
    BILL_SPEC_VIEW_BILL ( 2304, "Billing Specialist viewed specific bill", true ),

    /**
     * HCP created bill for patient.
     */
    CREATE_BILL ( 2304, "Bill created", true ),

    /**
     * HCP edited bill for patient.
     */
    EDIT_BILL ( 2304, "Bill edited", true ),

    /**
     * Billing specialist paid bill for a patient.
     */
    BILL_SPEC_PAY_BILL ( 2401, "Billing Specialist paid bill for patient", true ),

    /**
     * Billing specialist updated the status for a bill.
     */
    BILL_SPEC_UPDATE_BILL_STATUS ( 2402, "Billing Specialist updated status for bill", true );
